...
new class extends Component
{
  ...
  public function actualizarRonda($ronda) {
    $this->ronda = $ronda;
    $this->redirectRoute('fa.qn.pronosticos', ['evento' => $this->evento->id, 'rd' => $this->ronda, "p" => $this->partId]);
  }

  #[On('participacion-seleccionada')]
  public function actualizaParticipacion($participacionId) {
    $this->redirectRoute('fa.qn.pronosticos', ['evento' => $this->evento->id, 'rd' => $this->ronda, "p" => $participacionId]);
  }
};
